...
export interface RoundsInputVaultUpgradeableInterface extends utils.Interface {
  functions: {
    ...
    "redeemBatchForShares(uint256[],uint256[],address,address)": FunctionFragment;
    "redeemForShares(uint256,uint256,address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "redeemBatchForShares",
    values: [BigNumberish[], BigNumberish[], string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "redeemForShares",
    values: [BigNumberish, BigNumberish, string, string]
  ): string;
  encodeFunctionData(
