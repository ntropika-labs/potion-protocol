...
export interface TestWrapperActionsContainerInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getAction" | "getActionsLength" | "initialize"
  ): FunctionFragment;
...
export interface TestWrapperActionsContainer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestWrapperActionsContainerInterface;
  ...
  callStatic: {
    ...
    initialize(actions: string[], overrides?: CallOverrides): Promise<void>;
  };
