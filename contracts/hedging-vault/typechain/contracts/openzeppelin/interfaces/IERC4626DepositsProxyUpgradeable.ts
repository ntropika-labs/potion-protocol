...
export interface IERC4626DepositsProxyUpgradeableInterface
...
export interface IERC4626DepositsProxyUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC4626DepositsProxyUpgradeableInterface;
