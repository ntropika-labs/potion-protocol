...
export interface ERC4626DepositsProxyUpgradeableInterface
...
export interface ERC4626DepositsProxyUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC4626DepositsProxyUpgradeableInterface;
