...
export interface IRoundsInputVaultInterface extends utils.Interface {
  functions: {
...
export interface IRoundsInputVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRoundsInputVaultInterface;
