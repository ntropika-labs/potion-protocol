...
export interface IOpynAddressBookInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getController" | "getOracle" | "getOtokenFactory"
  ): FunctionFragment;
...
export interface IOpynAddressBook extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOpynAddressBookInterface;
