...
export interface IActionsContainerInterface extends utils.Interface {
  functions: {
...
export interface IActionsContainer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IActionsContainerInterface;
