...
import type {
  IVaultV0,
  IVaultV0Interface,
} from "../../../contracts/interfaces/IVaultV0";
...
export class IVaultV0__factory {
  static readonly abi = _abi;
  static createInterface(): IVaultV0Interface {
    return new utils.Interface(_abi) as IVaultV0Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IVaultV0 {
    return new Contract(address, _abi, signerOrProvider) as IVaultV0;
  }
}
