        ...
        before(async () => {
            describe("PotionLiquidityPool (Generated Purchase Tests)", () => {
                describe("Successful create/buy/settle tests", () => {
                    ...
                    const singleLpSeller0 = new CounterpartyDetails(
                        potionLp1,
                        poolId1,
                        curve1,
                        criteria1,
                    ...
                    const singleLpSeller1 = new CounterpartyDetails(
                        potionLp1,
                        poolId1,
                        curve1,
                        criteria1,
                    ...
                    const singleLpSeller2 = new CounterpartyDetails(
                        potionLp2,
                        poolId1,
                        curve1,
                        criteria1,
                    ...
                    const successfulPurchaseParams: PurchaseParams[] = [
                        ...
                        new PurchaseParams(
                            "buyer1, 5 LPs (again; lower gas cost)",
                            potionBuyer1,
                            lowerStrikePut,
                            fiveLpSellers1,
                        ),
