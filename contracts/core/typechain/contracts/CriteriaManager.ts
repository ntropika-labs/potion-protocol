...
export interface CriteriaManagerInterface extends utils.Interface {
  functions: {
    "addCriteria((address,address,bool,uint256,uint256))": FunctionFragment;
    "addCriteriaSet(bytes32[])": FunctionFragment;
    "criteriaSetByHash(bytes32)": FunctionFragment;
    ...
    "registeredCriteria(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "criteriaSetByHash",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "registeredCriteria",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface CriteriaManager extends BaseContract {
