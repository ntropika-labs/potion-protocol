...
export interface PotionLiquidityPoolUpgradeTestInterface
  ...
  functions: {
    ...
    "setUpgradeTestVal(uint256)": FunctionFragment;
    ...
    "upgradeTestVal()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "upgradeTestVal",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PotionLiquidityPoolUpgradeTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PotionLiquidityPoolUpgradeTestInterface;
