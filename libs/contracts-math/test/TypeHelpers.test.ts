...
import { CurveCriteria, OrderedCriteria } from "../src/typeHelpers";

describe("OrderedCriteria tests", () => {
  it("gets an ordered criteria", () => {
    const mockUnderlyingTokenAddress =
    ...
    const criteria_60days_80pct = new CurveCriteria(
      mockUnderlyingTokenAddress,
      mockStrikeTokenAddress,
      true,
      80,
    ...
    const criterias = [
      criteria_10days_110pct,
      criteria_30days_100pct,
      criteria_60days_80pct,
    ];
